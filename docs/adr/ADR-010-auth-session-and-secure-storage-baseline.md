...
> **SUPERSEDED by ADR-021 (2026-06-26):** Bu ADR'nin backend-managed HttpOnly cookie kararı, Firebase Auth lehine geçersizdir. Tarihsel referans olarak korunur. Canonical auth platform kararı için bkz. `ADR-021-authentication-platform.md`; backend & data platform kararı için bkz. `ADR-020-backend-and-data-platform.md`. ADR-010'un platform-bağımsız ilkeleri (auth artefact ≠ UI summary, deterministic cleanup, secure storage disiplini, observability privacy, biometric/social login/passkey) ADR-021'de korunur.

## Doküman Kimliği

- **ADR ID:** ADR-010
- **Başlık:** Auth, Session and Secure Storage Baseline
- **Durum:** Superseded (ADR-021 tarafından, 2026-06-26)
- **Tarih:** 2026-03-31
