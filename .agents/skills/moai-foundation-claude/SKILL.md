---
name: moai-foundation-Codex
description: >
  Canonical Codex authoring kit covering Skills, sub-agents, plugins, slash commands,
  hooks, memory, settings, sandboxing, headless mode, and advanced agent patterns.
  Use when creating Codex extensions or configuring Codex features.
license: Apache-2.0
...
metadata:
  ...
  updated: "2026-01-11"
  modularized: "false"
  tags: "foundation, Codex, skills, sub-agents, plugins, slash-commands, hooks, memory, settings, sandboxing, headless, agent-patterns"
  aliases: "moai-foundation-Codex"
...
triggers:
  keywords: ["skill", "agent", "plugin", "slash command", "hook", "sandbox", "headless", "memory", "settings", "Codex", "sub-agent", "agent pattern", "orchestration", "delegation"]
  agents:
    - "builder-agent"
    - "builder-skill"
    - "builder-plugin"
...
Comprehensive reference for Codex Skills, sub-agents, plugins, slash commands, hooks, memory, settings, sandboxing, headless mode, and advanced agent patterns.

## Documentation Index

Core Features:

- reference/Codex-skills-official.md - Agent Skills creation and management
- reference/Codex-sub-agents-official.md - Sub-agent development and delegation
- reference/Codex-plugins-official.md - Plugin architecture and distribution
- reference/Codex-custom-slash-commands-official.md - Command creation and orchestration

Configuration:

- reference/Codex-settings-official.md - Configuration hierarchy and management
- reference/Codex-memory-official.md - Context and knowledge persistence
- reference/Codex-hooks-official.md - Event-driven automation
- reference/Codex-iam-official.md - Access control and security

Advanced Features:

- reference/Codex-sandboxing-official.md - Security isolation
- reference/Codex-headless-official.md - Programmatic and CI/CD usage
- reference/Codex-devcontainers-official.md - Containerized environments
- reference/Codex-cli-reference-official.md - Command-line interface
- reference/Codex-statusline-official.md - Custom status display
- reference/advanced-agent-patterns.md - Engineering best practices

## Quick Reference

Skills: Model-invoked extensions in ~/.Codex/skills/ (personal) or .Codex/skills/ (project). Three-level progressive disclosure. Max 500 lines.

Sub-agents: Specialized assistants via Agent(subagent_type="..."). Own 200K context. Cannot spawn sub-agents. Use /agents command.

Plugins: Reusable bundles in .Codex-plugin/plugin.json. Include commands, agents, skills, hooks, MCP servers.
...
Memory: AGENTS.md files + .Codex/rules/*.md. Enterprise to Project to User hierarchy. @import syntax.
...
Create my-plugin directory with .Codex-plugin/plugin.json, commands directory, agents directory, skills directory, hooks/hooks.json, and .mcp.json file.
...
- moai-foundation-Codex: This authoring kit
...
- Validate inputs before passing to Codex
...
- v5.0.0 (2026-01-11): Converted to narrative format per AGENTS.md Documentation Standards
